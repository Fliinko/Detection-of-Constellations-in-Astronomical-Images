...
counter += 1
cv2.imwrite("Images/res1.png", thresh)
...
image = cv2.imread("Images/res1.png")
...
cv2.imwrite("Preprocessed/2.png", image, [cv2.IMWRITE_PNG_COMPRESSION, 0])
...
PointPlotter("Preprocessed/2.png")
